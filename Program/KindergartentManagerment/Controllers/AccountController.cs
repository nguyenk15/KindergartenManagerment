...
namespace KindergartentManagerment.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //private KindergartentManagermentdb db;
        ...
        public ActionResult Register()
        {
            ...
            {
                ViewBag.Name = new SelectList(context.Roles.Where(u => u.Name.Contains("Guest"))
                                            .ToList(), "Name", "Name");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (file != null)
                    {
                        string pic = model.UserName;
                        string path = Server.MapPath("//Content/profile/") + pic;
                        ...
                        user.ImageURL = "/Content/profile/" + pic + "_128x128" + ".jpg";
                        user.ImageURL1 = "/Content/profile/" + pic + "_160x160" + ".jpg";

                    }
                    else
                    {
                        user.ImageURL = "/Content/profile/" + "user_128x128" + ".png";
